...
class NodeModel {
    ...
    flattenNodes(nodes, parent = {}, depth = 0) {
        ...
        nodes.forEach((node, index) => {
            ...
            this.flatNodes[node.value] = {
                ...
                isParent,
                isLeaf: !isParent,
                showDefaultPlannerCheckbox: depth == 0,
    ...
    deserializeLists(lists) {
        const listKeys = ['checked', 'expanded', "plannerChecked"];
    ...
    togglePlannerChecked(node, isChecked){
         this.flatNodes[node.value]["plannerChecked"] = isChecked;
    }
