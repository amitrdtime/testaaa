...
class TreeNode extends React.PureComponent {
    static propTypes = {
        ...
        onPlannerClick: PropTypes.func,
        isPlannerChecked: PropTypes.bool.isRequired,
    };
    ...
    onPlannerClick(e) {
        const { value, onPlannerClick } = this.props;

        onPlannerClick({value, checked: e.target.checked })
    }
    ...
    renderDefaultPlanner() {

        const { isPlannerChecked, checked } = this.props;
        ...
        return (
            ...
            <span>
              <input id = {"chk_" + uid} type="checkbox" 
                ...
                checked= { isPlannerChecked }
                onClick={this.onPlannerClick}
                disabled = { checked === 0 }
                ></input>
              <label htmlFor= {"chk_" + uid}>Default Planner</label>
            </span>
            ) : ""
        );
    }
    ...
    renderLabel() {
        const { label, showCheckbox, showNodeIcon, isParent } = this.props;
        const labelChildren = [
                showNodeIcon ? (
                    <span key={0} style={{flexGrow: "2"}} className="rct-node-icon">
                        {this.renderNodeIcon()}
                    </span>
                ) : null,
        ...
        return (
            ...
            >
                <span className="rct-text">
                    <table style= {{display: "inline-flex", padding: "0", margin: "0"}}>
                        <tr style= {{padding: "0", margin: "0"}}>
                            <td style= {{padding: "0", marginLeft: "0"}}>
                                {this.renderCollapseButton()}
                            </td>
                            <td style= {{paddingLeft: "0", marginLeft: "0"}}>
                                {this.renderLabel()}
                            </td>
