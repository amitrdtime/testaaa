...
class CheckboxTree extends React.Component {
    ...
    constructor(props) {
        ...
        model.deserializeLists({
            ...
            plannerChecked: props.plannerChecked,
        });
    ...
    static getDerivedStateFromProps(newProps, prevState) {
        ...
        model.deserializeLists({
            ...
            plannerChecked: newProps.plannerChecked,
        });

        return newState;
    }

    onPlannerClick(nodeInfo){
        const { onPlannerChecked } = this.props;

        const model = this.state.model.clone();
        const node = model.getNode(nodeInfo.value);

        model.togglePlannerChecked(nodeInfo, nodeInfo.checked);
        onPlannerChecked(model.serializeList('plannerChecked'), { ...node, ...nodeInfo });
    }
    ...
    renderTreeNodes(nodes, parent = {}) {
        ...
        //   
            ...
            // 
            flatNode.checkPlannerState = this.state.model.props.plannerChecked.indexOf(key.toString()) > -1;
            // 
            // 
            ...
            return (
                <TreeNode
                    ...
                    onPlannerClick={this.onPlannerClick}
                    isPlannerChecked= {flatNode.checkPlannerState}
                >
                    {children}
                </TreeNode>
            );
